...
object ConjugatorPortuguese {
    ...
    fun getSubject(index: Int, enabledThirdPersons: BooleanArray): String {
        return when (index) {
            ...
            5 -> {
                ...
                val enabledThird = if (enabledThirdPlur.indexOf(true) == -1) booleanArrayOf(true, true, false) else enabledThirdPlur
                (subjects[index].filterIndexed { i, _ -> enabledThird[i] }.random()).random()
            }
            else -> {
                subjects[index][0][0]
    ...
    private fun conjugatePresInd(infinitive: String, verbClass: VerbClass, presIndStem: String): Array<String?> {
        return when (verbClass) {
            ...
            VerbClass.POR2, VerbClass.POR1 -> arrayOf(presIndStem + "onho", presIndStem + "ões", presIndStem + "õe", presIndStem + "omos", presIndStem + "ondes", presIndStem + "õem")
    ...
    private fun conjugateImpInd(verbClass: VerbClass, impIndStem: String): Array<String?> {
        return when (verbClass) {
            ...
            VerbClass.POR2, VerbClass.POR1 -> arrayOf(impIndStem + "unha", impIndStem + "unhas", impIndStem + "unha", impIndStem + "únhamos", impIndStem + "únheis", impIndStem + "unham")
    ...
    private fun conjugatePretInd(verbClass: VerbClass, pretIndStem: String): Array<String?> {
        return when (verbClass) {
            ...
            VerbClass.POR2, VerbClass.POR1 -> arrayOf(pretIndStem + "us", pretIndStem + "useste", pretIndStem + "ôs", pretIndStem + "usemos", pretIndStem + "usestes", pretIndStem + "useram")
    ...
    private fun conjugateSimpPlupInd(verbClass: VerbClass, plupIndStem: String): Array<String?> {
        return when (verbClass) {
            ...
            VerbClass.TER, VerbClass.FAZER, VerbClass.POR2, VerbClass.DIZER, VerbClass.QUERER, VerbClass.CABER, VerbClass.ESTAR, VerbClass.HAVER, VerbClass.PODER, VerbClass.POR1, VerbClass.TRAZER, VerbClass.VIR, VerbClass.DAR -> arrayOf(plupIndStem + "era", plupIndStem + "eras", plupIndStem + "era", plupIndStem + "éramos", plupIndStem + "éreis", plupIndStem + "eram")
    ...
    private fun conjugateImpSubj(verbClass: VerbClass, impSubjStem: String): Array<String?> {
        ...
        return when (verbClass) {
            ...
            VerbClass.TER, VerbClass.FAZER, VerbClass.POR2, VerbClass.DIZER, VerbClass.QUERER, VerbClass.CABER, VerbClass.ESTAR, VerbClass.HAVER, VerbClass.PODER, VerbClass.POR1, VerbClass.SABER, VerbClass.TRAZER, VerbClass.VIR, VerbClass.DAR -> arrayOf(impSubjStem + "esse", impSubjStem + "esses", impSubjStem + "esse", impSubjStem + "éssemos", impSubjStem + "ésseis", impSubjStem + "essem")
    ...
    private fun conjugateImpAff(infinitive: String, verbClass: VerbClass, impAffStem: String): Array<String?> {
        return when (verbClass) {
            ...
            VerbClass.POR2, VerbClass.POR1 -> arrayOf(null, impAffStem + "õe", impAffStem + "onha", impAffStem + "onhamos", impAffStem + "onde", impAffStem + "onham")
    ...
    private fun conjugatePersInf(verbClass: VerbClass, persInfStem: String): Array<String?> {
        return when (verbClass) {
            ...
            VerbClass.POR1 -> arrayOf(persInfStem + "ôr", persInfStem + "ores", persInfStem + "ôr", persInfStem + "ormos", persInfStem + "ordes", persInfStem + "orem")
